...
CKPT = '/mnt/datadrive/annh/GLAMR/pose_est/hybrik_demo/pretrained_w_cam.pth'
# CKPT = '/mnt/datadrive/annh/GLAMR/pose_est/hybrik_demo/hybrik_hrnet.pth'
...
if opt.multi:
    ...
    for frame_idx in tqdm(range(len(img_path_list))):
        ...
        print("from hybrik_demo/demo.py: ",img_path)
    ...
    for img_path in tqdm(img_path_list):
        ...
        # print("from demo.py: img_path", img_path) #  /mnt/datadrive/annh/GLAMR/out/glamr_dynamic/20_in/pose_est/frames/000074.jpg, ...000075.jpg
        dirname = os.path.dirname(img_path)
        basename = os.path.basename(img_path)
        ...
        transl = pose_output.transl.detach().cpu().numpy().squeeze()
        # print("from demo.py: transl", transl)
        transl[2] = transl[2] * 256 / bbox_xywh[2]
